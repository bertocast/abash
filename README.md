...
- Unsupported today: shell variables that persist across separate exec calls, backtick command substitution, heredoc tab-stripping via `<<-`, broader fd juggling beyond `2>`, `2>>`, `2>&1`, job control, and TTY semantics.
