...
- narrow `awk` with optional `-F`, `-v`, `BEGIN`/`END`, `print`, `printf`, variables, basic assignments and arithmetic, regex literals, `$0/$N`, `NF/NR/FNR/FILENAME`, and basic comparisons / `~` / `!~`: supported
