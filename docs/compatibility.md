...
- narrow `xan` CSV toolkit with `headers`, `count`, `head`, `tail`, `slice`, `reverse`, `behead`, `cat`, `select`, `drop`, `rename`, `enum`, `search`, `sort`, `dedup`, `top`, `frequency`, `stats`, `agg`, and `filter`: supported
